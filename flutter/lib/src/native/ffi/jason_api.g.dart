...
void connectionHandleOnClose({ required ConnectionHandle connection,required Object f,dynamic hint });
...
void connectionHandleOnRemoteTrackAdded({ required ConnectionHandle connection,required Object f,dynamic hint });

FlutterRustBridgeTaskConstMeta get kConnectionHandleOnRemoteTrackAddedConstMeta;
...
void connectionHandleOnQualityScoreUpdate({ required ConnectionHandle connection,required Object f,dynamic hint });

FlutterRustBridgeTaskConstMeta get kConnectionHandleOnQualityScoreUpdateConstMeta;
...
String connectionHandleGetRemoteMemberId({ required ConnectionHandle connection,dynamic hint });

FlutterRustBridgeTaskConstMeta get kConnectionHandleGetRemoteMemberIdConstMeta;

/// Enables inbound audio in this [`ConnectionHandle`].
///
/// [`ConnectionHandle`]: crate::connection::ConnectionHandle
Object connectionHandleEnableRemoteAudio({ required ConnectionHandle connection,dynamic hint });

FlutterRustBridgeTaskConstMeta get kConnectionHandleEnableRemoteAudioConstMeta;

/// Disables inbound audio in this [`ConnectionHandle`].
///
/// [`ConnectionHandle`]: crate::connection::ConnectionHandle
Object connectionHandleDisableRemoteAudio({ required ConnectionHandle connection,dynamic hint });

FlutterRustBridgeTaskConstMeta get kConnectionHandleDisableRemoteAudioConstMeta;
...
///
/// [`ConnectionHandle`]: crate::connection::ConnectionHandle
Object connectionHandleEnableRemoteVideo({ required ConnectionHandle connection,int? sourceKind,dynamic hint });

FlutterRustBridgeTaskConstMeta get kConnectionHandleEnableRemoteVideoConstMeta;
...
///
/// [`ConnectionHandle`]: crate::connection::ConnectionHandle
Object connectionHandleDisableRemoteVideo({ required ConnectionHandle connection,int? sourceKind,dynamic hint });

FlutterRustBridgeTaskConstMeta get kConnectionHandleDisableRemoteVideoConstMeta;
...
void jasonCloseRoom({ required Jason jason,required RoomHandle roomToDelete,dynamic hint });
...
Object localMediaTrackGetTrack({ required LocalMediaTrack track,dynamic hint });
...
MediaSourceKind localMediaTrackMediaSourceKind({ required LocalMediaTrack track,dynamic hint });
...
/// [`ForeignClass`].
List<ApiMediaDeviceInfo> vecMediaDeviceInfoFromPtr({ required int ptr,dynamic hint });
...
/// [`ForeignClass`].
List<ApiMediaDisplayInfo> vecMediaDisplayInfoFromPtr({ required int ptr,dynamic hint });
...
Object mediaManagerHandleInitLocalTracks({ required MediaManagerHandle manager,required ApiMediaStreamSettings caps,dynamic hint });

FlutterRustBridgeTaskConstMeta get kMediaManagerHandleInitLocalTracksConstMeta;
...
Object mediaManagerHandleEnumerateDevices({ required MediaManagerHandle manager,dynamic hint });

FlutterRustBridgeTaskConstMeta get kMediaManagerHandleEnumerateDevicesConstMeta;

/// Returns a list of [`ApiMediaDisplayInfo`] objects representing available
/// sources that can be used for screen capturing.
Object mediaManagerHandleEnumerateDisplays({ required MediaManagerHandle manager,dynamic hint });

FlutterRustBridgeTaskConstMeta get kMediaManagerHandleEnumerateDisplaysConstMeta;

/// Switches the current output audio device to the device with the provided
/// `device_id`.
Object mediaManagerHandleSetOutputAudioId({ required MediaManagerHandle manager,required String deviceId,dynamic hint });

FlutterRustBridgeTaskConstMeta get kMediaManagerHandleSetOutputAudioIdConstMeta;

/// Sets the microphone volume level in percents.
Object mediaManagerHandleSetMicrophoneVolume({ required MediaManagerHandle manager,required int level,dynamic hint });

FlutterRustBridgeTaskConstMeta get kMediaManagerHandleSetMicrophoneVolumeConstMeta;

/// Indicates whether it's possible to access microphone volume settings.
Object mediaManagerHandleMicrophoneVolumeIsAvailable({ required MediaManagerHandle manager,dynamic hint });

FlutterRustBridgeTaskConstMeta get kMediaManagerHandleMicrophoneVolumeIsAvailableConstMeta;

/// Returns the current microphone volume level in percents.
Object mediaManagerHandleMicrophoneVolume({ required MediaManagerHandle manager,dynamic hint });

FlutterRustBridgeTaskConstMeta get kMediaManagerHandleMicrophoneVolumeConstMeta;
...
void mediaManagerHandleOnDeviceChange({ required MediaManagerHandle manager,required Object cb,dynamic hint });
...
///
/// [`Room`]: crate::room::Room
Object reconnectHandleReconnectWithDelay({ required ReconnectHandle reconnectHandle,required int delayMs,dynamic hint });

FlutterRustBridgeTaskConstMeta get kReconnectHandleReconnectWithDelayConstMeta;
...
///
/// [`Room`]: crate::room::Room
Object reconnectHandleReconnectWithBackoff({ required ReconnectHandle reconnectHandle,required int startingDelay,required double multiplier,required int maxDelay,int? maxElapsedTimeMs,dynamic hint });

FlutterRustBridgeTaskConstMeta get kReconnectHandleReconnectWithBackoffConstMeta;
...
Object remoteMediaTrackGetTrack({ required RemoteMediaTrack track,dynamic hint });

FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackGetTrackConstMeta;

/// Sets callback to invoke when this [`RemoteMediaTrack`] is muted.
void remoteMediaTrackOnMuted({ required RemoteMediaTrack track,required Object f,dynamic hint });
...
void remoteMediaTrackOnUnmuted({ required RemoteMediaTrack track,required Object f,dynamic hint });
...
void remoteMediaTrackOnStopped({ required RemoteMediaTrack track,required Object f,dynamic hint });
...
void remoteMediaTrackOnMediaDirectionChanged({ required RemoteMediaTrack track,required Object f,dynamic hint });

FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackOnMediaDirectionChangedConstMeta;
...
MediaKind remoteMediaTrackKind({ required RemoteMediaTrack track,dynamic hint });

FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackKindConstMeta;

/// Returns this [`RemoteMediaTrack`]'s media source kind.
MediaSourceKind remoteMediaTrackMediaSourceKind({ required RemoteMediaTrack track,dynamic hint });
...
MediaDirection remoteMediaTrackMediaDirection({ required RemoteMediaTrack track,dynamic hint });
...
///
/// [`Room`]: crate::room::Room
Object roomHandleJoin({ required RoomHandle roomHandle,required String token,dynamic hint });
...
Object roomHandleSetLocalMediaSettings({ required RoomHandle roomHandle,required ApiMediaStreamSettings settings,required bool stopFirst,required bool rollbackOnFail,dynamic hint });
...
Object roomHandleMuteVideo({ required RoomHandle roomHandle,int? sourceKind,dynamic hint });
...
///
/// If `source_kind` is not a [`MediaSourceKind`] index.
Object roomHandleUnmuteVideo({ required RoomHandle roomHandle,int? sourceKind,dynamic hint });
...
Object roomHandleEnableVideo({ required RoomHandle roomHandle,int? sourceKind,dynamic hint });
...
///
/// If `source_kind` is not [`MediaSourceKind`] index.
Object roomHandleDisableVideo({ required RoomHandle roomHandle,int? sourceKind,dynamic hint });
...
///
/// [`Room`]: crate::room::Room
Object roomHandleEnableRemoteAudio({ required RoomHandle roomHandle,dynamic hint });
...
///
/// [`Room`]: crate::room::Room
Object roomHandleDisableRemoteAudio({ required RoomHandle roomHandle,dynamic hint });
...
///
/// If `source_kind` is not [`MediaSourceKind`] index.
Object roomHandleEnableRemoteVideo({ required RoomHandle roomHandle,int? sourceKind,dynamic hint });
...
///
/// If `source_kind` is not [`MediaSourceKind`] index.
Object roomHandleDisableRemoteVideo({ required RoomHandle roomHandle,int? sourceKind,dynamic hint });
...
void roomHandleOnNewConnection({ required RoomHandle roomHandle,required Object cb,dynamic hint });
...
void roomHandleOnClose({ required RoomHandle roomHandle,required Object cb,dynamic hint });
...
void roomHandleOnLocalTrack({ required RoomHandle roomHandle,required Object cb,dynamic hint });
...
void roomHandleOnConnectionLoss({ required RoomHandle roomHandle,required Object cb,dynamic hint });
...
void roomHandleOnFailedLocalMedia({ required RoomHandle roomHandle,required Object cb,dynamic hint });
...
FlutterRustBridgeTaskConstMeta get kRoomHandleOnFailedLocalMediaConstMeta;
    ...
    OpaqueTypeFinalizer get RoomHandleFinalizer;
        ...
        @sealed class ConnectionHandle extends FrbOpaque {
                final MedeaJason bridge;
                    ConnectionHandle.fromRaw(int ptr, int size, this.bridge) : super.unsafe(ptr, size);
                    @override
...
@sealed class Jason extends FrbOpaque {
                final MedeaJason bridge;
...
@sealed class LocalMediaTrack extends FrbOpaque {
                final MedeaJason bridge;
                    LocalMediaTrack.fromRaw(int ptr, int size, this.bridge) : super.unsafe(ptr, size);
                    @override
...
@sealed class MediaManagerHandle extends FrbOpaque {
                final MedeaJason bridge;
                    MediaManagerHandle.fromRaw(int ptr, int size, this.bridge) : super.unsafe(ptr, size);
                    @override
...
@sealed class ReconnectHandle extends FrbOpaque {
                final MedeaJason bridge;
                    ReconnectHandle.fromRaw(int ptr, int size, this.bridge) : super.unsafe(ptr, size);
                    @override
...
@sealed class RemoteMediaTrack extends FrbOpaque {
                final MedeaJason bridge;
                    RemoteMediaTrack.fromRaw(int ptr, int size, this.bridge) : super.unsafe(ptr, size);
                    @override
...
@sealed class RoomHandle extends FrbOpaque {
                final MedeaJason bridge;
...
class ApiAudioTrackConstrs {
 ...
 String? deviceId;
                ...
                ApiAudioTrackConstrs({this.deviceId,});
...
const factory ApiConstrainFacingMode.exact(FacingMode field0,) = ApiConstrainFacingMode_Exact;
/// Ideal (target) value for this property.
const factory ApiConstrainFacingMode.ideal(FacingMode field0,) = ApiConstrainFacingMode_Ideal;
                }
...
/// Width of the video in pixels.
 ApiOptionConstrainU32 width;
                ...
                ApiDeviceVideoTrackConstrs({this.deviceId,required this.facingMode,required this.height,required this.width,});
...
/// [1]: https://w3.org/TR/mediacapture-streams#dfn-framerate
 ApiOptionConstrainU32 frameRate;
                ...
                ApiDisplayVideoTrackConstrs({this.deviceId,required this.height,required this.width,required this.frameRate,});
...
final String? groupId;
                ...
                ApiMediaDeviceInfo({required this.kind,required this.deviceId,required this.label,this.groupId,});
...
final String? title;
                ...
                ApiMediaDisplayInfo({required this.deviceId,this.title,});
...
/// [1]: https://w3.org/TR/mediacapture-streams#dom-mediastreamconstraints
 ApiDisplayVideoTrackConstrs? displayVideo;
                ...
                ApiMediaStreamSettings({required this.audio,this.deviceVideo,this.displayVideo,});
...
@freezed
                class ApiOptionConstrainFacingMode with _$ApiOptionConstrainFacingMode {
                    const factory ApiOptionConstrainFacingMode.some(ApiConstrainFacingMode field0,) = ApiOptionConstrainFacingMode_Some;
const factory ApiOptionConstrainFacingMode.none() = ApiOptionConstrainFacingMode_None;
                }

@freezed
                class ApiOptionConstrainU32 with _$ApiOptionConstrainU32 {
                    const factory ApiOptionConstrainU32.some(ConstrainU32 field0,) = ApiOptionConstrainU32_Some;
/// Lack of value.
...
final bool isErr;
                ...
                RoomCloseReason({required this.isClosedByServer,required this.reason,required this.isErr,});
...
class MedeaJasonImpl implements MedeaJason {
                ...
                factory MedeaJasonImpl(ExternalLibrary dylib) => MedeaJasonImpl.raw(MedeaJasonPlatform(dylib));
...
ConnectionHandle connectionHandleFromPtr({ required int ptr,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kConnectionHandleFromPtrConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(f);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_connection_handle_on_close(arg0, arg1),
        ...
        FlutterRustBridgeTaskConstMeta get kConnectionHandleOnCloseConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(f);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_connection_handle_on_remote_track_added(arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kConnectionHandleOnRemoteTrackAddedConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(f);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_connection_handle_on_quality_score_update(arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kConnectionHandleOnQualityScoreUpdateConstMeta => const FlutterRustBridgeTaskConstMeta(
...
String connectionHandleGetRemoteMemberId({ required ConnectionHandle connection,dynamic hint }) {
            var arg0 = _platform.api2wire_ConnectionHandle(connection);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_connection_handle_get_remote_member_id(arg0),
        ...
        FlutterRustBridgeTaskConstMeta get kConnectionHandleGetRemoteMemberIdConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object connectionHandleEnableRemoteAudio({ required ConnectionHandle connection,dynamic hint }) {
            var arg0 = _platform.api2wire_ConnectionHandle(connection);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_connection_handle_enable_remote_audio(arg0),
        ...
        FlutterRustBridgeTaskConstMeta get kConnectionHandleEnableRemoteAudioConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object connectionHandleDisableRemoteAudio({ required ConnectionHandle connection,dynamic hint }) {
            var arg0 = _platform.api2wire_ConnectionHandle(connection);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_connection_handle_disable_remote_audio(arg0),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kConnectionHandleDisableRemoteAudioConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_opt_box_autoadd_i64(sourceKind);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_connection_handle_enable_remote_video(arg0, arg1),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kConnectionHandleEnableRemoteVideoConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_opt_box_autoadd_i64(sourceKind);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_connection_handle_disable_remote_video(arg0, arg1),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kConnectionHandleDisableRemoteVideoConstMeta => const FlutterRustBridgeTaskConstMeta(
...
void onPanic({ required Object cb,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kOnPanicConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "on_panic",
            argNames: ["cb"],
        );
...
Jason jasonNew({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kJasonNewConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "jason_new",
            argNames: [],
        );
...
RoomHandle jasonInitRoom({ required Jason jason,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kJasonInitRoomConstMeta => const FlutterRustBridgeTaskConstMeta(
...
MediaManagerHandle jasonMediaManager({ required Jason jason,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kJasonMediaManagerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_RoomHandle(roomToDelete);
        ...
        FlutterRustBridgeTaskConstMeta get kJasonCloseRoomConstMeta => const FlutterRustBridgeTaskConstMeta(
...
void jasonDispose({ required Jason jason,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kJasonDisposeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
LocalMediaTrack localMediaTrackFromPtr({ required int ptr,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kLocalMediaTrackFromPtrConstMeta => const FlutterRustBridgeTaskConstMeta(
...
List<LocalMediaTrack> vecLocalTracksFromPtr({ required int ptr,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kVecLocalTracksFromPtrConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object localMediaTrackGetTrack({ required LocalMediaTrack track,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kLocalMediaTrackGetTrackConstMeta => const FlutterRustBridgeTaskConstMeta(
...
MediaKind localMediaTrackKind({ required LocalMediaTrack track,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kLocalMediaTrackKindConstMeta => const FlutterRustBridgeTaskConstMeta(
...
MediaSourceKind localMediaTrackMediaSourceKind({ required LocalMediaTrack track,dynamic hint }) {
            var arg0 = _platform.api2wire_LocalMediaTrack(track);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_local_media_track_media_source_kind(arg0),
        ...
        FlutterRustBridgeTaskConstMeta get kLocalMediaTrackMediaSourceKindConstMeta => const FlutterRustBridgeTaskConstMeta(
...
List<ApiMediaDeviceInfo> vecMediaDeviceInfoFromPtr({ required int ptr,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kVecMediaDeviceInfoFromPtrConstMeta => const FlutterRustBridgeTaskConstMeta(
...
List<ApiMediaDisplayInfo> vecMediaDisplayInfoFromPtr({ required int ptr,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kVecMediaDisplayInfoFromPtrConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_box_autoadd_api_media_stream_settings(caps);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_media_manager_handle_init_local_tracks(arg0, arg1),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kMediaManagerHandleInitLocalTracksConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object mediaManagerHandleEnumerateDevices({ required MediaManagerHandle manager,dynamic hint }) {
            var arg0 = _platform.api2wire_MediaManagerHandle(manager);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_media_manager_handle_enumerate_devices(arg0),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kMediaManagerHandleEnumerateDevicesConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object mediaManagerHandleEnumerateDisplays({ required MediaManagerHandle manager,dynamic hint }) {
            var arg0 = _platform.api2wire_MediaManagerHandle(manager);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_media_manager_handle_enumerate_displays(arg0),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kMediaManagerHandleEnumerateDisplaysConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(deviceId);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_media_manager_handle_set_output_audio_id(arg0, arg1),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kMediaManagerHandleSetOutputAudioIdConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_i64(level);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_media_manager_handle_set_microphone_volume(arg0, arg1),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kMediaManagerHandleSetMicrophoneVolumeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object mediaManagerHandleMicrophoneVolumeIsAvailable({ required MediaManagerHandle manager,dynamic hint }) {
            var arg0 = _platform.api2wire_MediaManagerHandle(manager);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_media_manager_handle_microphone_volume_is_available(arg0),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kMediaManagerHandleMicrophoneVolumeIsAvailableConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object mediaManagerHandleMicrophoneVolume({ required MediaManagerHandle manager,dynamic hint }) {
            var arg0 = _platform.api2wire_MediaManagerHandle(manager);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_media_manager_handle_microphone_volume(arg0),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kMediaManagerHandleMicrophoneVolumeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(cb);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_media_manager_handle_on_device_change(arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kMediaManagerHandleOnDeviceChangeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
ReconnectHandle reconnectHandleFromPtr({ required int ptr,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kReconnectHandleFromPtrConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_i64(delayMs);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_reconnect_handle_reconnect_with_delay(arg0, arg1),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kReconnectHandleReconnectWithDelayConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg4 = _platform.api2wire_opt_box_autoadd_i64(maxElapsedTimeMs);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_reconnect_handle_reconnect_with_backoff(arg0, arg1, arg2, arg3, arg4),
            parseSuccessData: _wire2api_DartOpaque,
            
        constMeta: kReconnectHandleReconnectWithBackoffConstMeta,
        argValues: [reconnectHandle, startingDelay, multiplier, maxDelay, maxElapsedTimeMs],
        hint: hint,
        
        ));}


        FlutterRustBridgeTaskConstMeta get kReconnectHandleReconnectWithBackoffConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "reconnect_handle_reconnect_with_backoff",
            argNames: ["reconnectHandle", "startingDelay", "multiplier", "maxDelay", "maxElapsedTimeMs"],
        );
...
RemoteMediaTrack remoteMediaTrackFromPtr({ required int ptr,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackFromPtrConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object remoteMediaTrackGetTrack({ required RemoteMediaTrack track,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackGetTrackConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(f);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_remote_media_track_on_muted(arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackOnMutedConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(f);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_remote_media_track_on_unmuted(arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackOnUnmutedConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(f);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_remote_media_track_on_stopped(arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackOnStoppedConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(f);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_remote_media_track_on_media_direction_changed(arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackOnMediaDirectionChangedConstMeta => const FlutterRustBridgeTaskConstMeta(
...
bool remoteMediaTrackMuted({ required RemoteMediaTrack track,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackMutedConstMeta => const FlutterRustBridgeTaskConstMeta(
...
MediaKind remoteMediaTrackKind({ required RemoteMediaTrack track,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackKindConstMeta => const FlutterRustBridgeTaskConstMeta(
...
MediaSourceKind remoteMediaTrackMediaSourceKind({ required RemoteMediaTrack track,dynamic hint }) {
            var arg0 = _platform.api2wire_RemoteMediaTrack(track);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_remote_media_track_media_source_kind(arg0),
            parseSuccessData: _wire2api_media_source_kind,
        ...
        FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackMediaSourceKindConstMeta => const FlutterRustBridgeTaskConstMeta(
...
MediaDirection remoteMediaTrackMediaDirection({ required RemoteMediaTrack track,dynamic hint }) {
            var arg0 = _platform.api2wire_RemoteMediaTrack(track);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_remote_media_track_media_direction(arg0),
        ...
        FlutterRustBridgeTaskConstMeta get kRemoteMediaTrackMediaDirectionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
RoomCloseReason roomCloseReasonFromPtr({ required int ptr,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kRoomCloseReasonFromPtrConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_String(token);
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleJoinConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object roomHandleSetLocalMediaSettings({ required RoomHandle roomHandle,required ApiMediaStreamSettings settings,required bool stopFirst,required bool rollbackOnFail,dynamic hint }) {
            var arg0 = _platform.api2wire_RoomHandle(roomHandle);
var arg1 = _platform.api2wire_box_autoadd_api_media_stream_settings(settings);
var arg2 = stopFirst;
var arg3 = rollbackOnFail;
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_room_handle_set_local_media_settings(arg0, arg1, arg2, arg3),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleSetLocalMediaSettingsConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object roomHandleMuteAudio({ required RoomHandle roomHandle,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleMuteAudioConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object roomHandleUnmuteAudio({ required RoomHandle roomHandle,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleUnmuteAudioConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object roomHandleEnableAudio({ required RoomHandle roomHandle,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleEnableAudioConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object roomHandleDisableAudio({ required RoomHandle roomHandle,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleDisableAudioConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_opt_box_autoadd_i64(sourceKind);
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleMuteVideoConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_opt_box_autoadd_i64(sourceKind);
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleUnmuteVideoConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_opt_box_autoadd_i64(sourceKind);
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleEnableVideoConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_opt_box_autoadd_i64(sourceKind);
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleDisableVideoConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object roomHandleEnableRemoteAudio({ required RoomHandle roomHandle,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleEnableRemoteAudioConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Object roomHandleDisableRemoteAudio({ required RoomHandle roomHandle,dynamic hint }) {
            var arg0 = _platform.api2wire_RoomHandle(roomHandle);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_room_handle_disable_remote_audio(arg0),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleDisableRemoteAudioConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_opt_box_autoadd_i64(sourceKind);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_room_handle_enable_remote_video(arg0, arg1),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleEnableRemoteVideoConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_opt_box_autoadd_i64(sourceKind);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_room_handle_disable_remote_video(arg0, arg1),
            parseSuccessData: _wire2api_DartOpaque,
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleDisableRemoteVideoConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(cb);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_room_handle_on_new_connection(arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleOnNewConnectionConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(cb);
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleOnCloseConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(cb);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_room_handle_on_local_track(arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleOnLocalTrackConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(cb);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_room_handle_on_connection_loss(arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleOnConnectionLossConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_DartOpaque(cb);
            return _platform.executeSync(FlutterRustBridgeSyncTask(
            callFfi: () => _platform.inner.wire_room_handle_on_failed_local_media(arg0, arg1),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kRoomHandleOnFailedLocalMediaConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "room_handle_on_failed_local_media",
            argNames: ["roomHandle", "cb"],
        );
        

        DropFnType get dropOpaqueConnectionHandle => _platform.inner.drop_opaque_ConnectionHandle;
        ShareFnType get shareOpaqueConnectionHandle => _platform.inner.share_opaque_ConnectionHandle;
        OpaqueTypeFinalizer get ConnectionHandleFinalizer => _platform.ConnectionHandleFinalizer;
        ...
        DropFnType get dropOpaqueLocalMediaTrack => _platform.inner.drop_opaque_LocalMediaTrack;
        ShareFnType get shareOpaqueLocalMediaTrack => _platform.inner.share_opaque_LocalMediaTrack;
        OpaqueTypeFinalizer get LocalMediaTrackFinalizer => _platform.LocalMediaTrackFinalizer;
        



        DropFnType get dropOpaqueMediaManagerHandle => _platform.inner.drop_opaque_MediaManagerHandle;
        ShareFnType get shareOpaqueMediaManagerHandle => _platform.inner.share_opaque_MediaManagerHandle;
        OpaqueTypeFinalizer get MediaManagerHandleFinalizer => _platform.MediaManagerHandleFinalizer;
        



        DropFnType get dropOpaqueReconnectHandle => _platform.inner.drop_opaque_ReconnectHandle;
        ShareFnType get shareOpaqueReconnectHandle => _platform.inner.share_opaque_ReconnectHandle;
        OpaqueTypeFinalizer get ReconnectHandleFinalizer => _platform.ReconnectHandleFinalizer;
        



        DropFnType get dropOpaqueRemoteMediaTrack => _platform.inner.drop_opaque_RemoteMediaTrack;
        ShareFnType get shareOpaqueRemoteMediaTrack => _platform.inner.share_opaque_RemoteMediaTrack;
        OpaqueTypeFinalizer get RemoteMediaTrackFinalizer => _platform.RemoteMediaTrackFinalizer;
        



        DropFnType get dropOpaqueRoomHandle => _platform.inner.drop_opaque_RoomHandle;
        ShareFnType get shareOpaqueRoomHandle => _platform.inner.share_opaque_RoomHandle;
...
ApiMediaDeviceInfo _wire2api_api_media_device_info(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return ApiMediaDeviceInfo(kind: _wire2api_media_device_kind(arr[0]),
...
ApiMediaDisplayInfo _wire2api_api_media_display_info(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return ApiMediaDisplayInfo(deviceId: _wire2api_String(arr[0]),
...
List<ApiMediaDisplayInfo> _wire2api_list_api_media_display_info(dynamic raw) {
            return (raw as List<dynamic>).map(_wire2api_api_media_display_info).toList();
        }
...
RoomCloseReason _wire2api_room_close_reason(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return RoomCloseReason(isClosedByServer: _wire2api_bool(arr[0]),
...
@protected
                    ffi.Pointer<wire_ApiAudioTrackConstrs> api2wire_box_api_audio_track_constrs(ApiAudioTrackConstrs raw) {
                        final ptr = inner.new_box_api_audio_track_constrs_0();
                        _api_fill_to_wire_api_audio_track_constrs(raw, ptr.ref);
                        return ptr;
                    }
@protected
                    ffi.Pointer<wire_ApiOptionConstrainFacingMode> api2wire_box_api_option_constrain_facing_mode(ApiOptionConstrainFacingMode raw) {
                        final ptr = inner.new_box_api_option_constrain_facing_mode_0();
                        _api_fill_to_wire_api_option_constrain_facing_mode(raw, ptr.ref);
                        return ptr;
                    }
@protected
                    ffi.Pointer<wire_ApiOptionConstrainU32> api2wire_box_api_option_constrain_u_32(ApiOptionConstrainU32 raw) {
                        final ptr = inner.new_box_api_option_constrain_u_32_0();
                        _api_fill_to_wire_api_option_constrain_u_32(raw, ptr.ref);
                        return ptr;
                    }
@protected
                    ffi.Pointer<wire_ApiConstrainFacingMode> api2wire_box_autoadd_api_constrain_facing_mode(ApiConstrainFacingMode raw) {
                        final ptr = inner.new_box_autoadd_api_constrain_facing_mode_0();
                        _api_fill_to_wire_api_constrain_facing_mode(raw, ptr.ref);
                        return ptr;
                    }
@protected
                    ffi.Pointer<wire_ApiDeviceVideoTrackConstrs> api2wire_box_autoadd_api_device_video_track_constrs(ApiDeviceVideoTrackConstrs raw) {
...
@protected
                    ffi.Pointer<wire_ApiDisplayVideoTrackConstrs> api2wire_box_autoadd_api_display_video_track_constrs(ApiDisplayVideoTrackConstrs raw) {
...
@protected
                    ffi.Pointer<wire_ApiMediaStreamSettings> api2wire_box_autoadd_api_media_stream_settings(ApiMediaStreamSettings raw) {
                        final ptr = inner.new_box_autoadd_api_media_stream_settings_0();
                        _api_fill_to_wire_api_media_stream_settings(raw, ptr.ref);
                        return ptr;
                    }
@protected
                    ffi.Pointer<wire_ConstrainU32> api2wire_box_autoadd_constrain_u_32(ConstrainU32 raw) {
...
@protected
                    ffi.Pointer<wire_ApiDeviceVideoTrackConstrs> api2wire_opt_box_autoadd_api_device_video_track_constrs(ApiDeviceVideoTrackConstrs? raw) {
                        return raw == null ? ffi.nullptr : api2wire_box_autoadd_api_device_video_track_constrs(raw);
                    }
@protected
                    ffi.Pointer<wire_ApiDisplayVideoTrackConstrs> api2wire_opt_box_autoadd_api_display_video_track_constrs(ApiDisplayVideoTrackConstrs? raw) {
                        return raw == null ? ffi.nullptr : api2wire_box_autoadd_api_display_video_track_constrs(raw);
                    }
@protected
...
late final OpaqueTypeFinalizer _ConnectionHandleFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_ConnectionHandlePtr);
            OpaqueTypeFinalizer get ConnectionHandleFinalizer => _ConnectionHandleFinalizer;
late final OpaqueTypeFinalizer _JasonFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_JasonPtr);
            OpaqueTypeFinalizer get JasonFinalizer => _JasonFinalizer;
late final OpaqueTypeFinalizer _LocalMediaTrackFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_LocalMediaTrackPtr);
            OpaqueTypeFinalizer get LocalMediaTrackFinalizer => _LocalMediaTrackFinalizer;
late final OpaqueTypeFinalizer _MediaManagerHandleFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_MediaManagerHandlePtr);
            OpaqueTypeFinalizer get MediaManagerHandleFinalizer => _MediaManagerHandleFinalizer;
late final OpaqueTypeFinalizer _ReconnectHandleFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_ReconnectHandlePtr);
            OpaqueTypeFinalizer get ReconnectHandleFinalizer => _ReconnectHandleFinalizer;
late final OpaqueTypeFinalizer _RemoteMediaTrackFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_RemoteMediaTrackPtr);
            OpaqueTypeFinalizer get RemoteMediaTrackFinalizer => _RemoteMediaTrackFinalizer;
late final OpaqueTypeFinalizer _RoomHandleFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_RoomHandlePtr);
            OpaqueTypeFinalizer get RoomHandleFinalizer => _RoomHandleFinalizer;
// Section: api_fill_to_wire

void _api_fill_to_wire_ConnectionHandle(ConnectionHandle apiObj, wire_ConnectionHandle wireObj) {
...
void _api_fill_to_wire_LocalMediaTrack(LocalMediaTrack apiObj, wire_LocalMediaTrack wireObj) {
                wireObj.ptr = apiObj.shareOrMove();
            }

void _api_fill_to_wire_MediaManagerHandle(MediaManagerHandle apiObj, wire_MediaManagerHandle wireObj) {
                wireObj.ptr = apiObj.shareOrMove();
            }

void _api_fill_to_wire_ReconnectHandle(ReconnectHandle apiObj, wire_ReconnectHandle wireObj) {
                wireObj.ptr = apiObj.shareOrMove();
            }

void _api_fill_to_wire_RemoteMediaTrack(RemoteMediaTrack apiObj, wire_RemoteMediaTrack wireObj) {
                wireObj.ptr = apiObj.shareOrMove();
            }

void _api_fill_to_wire_RoomHandle(RoomHandle apiObj, wire_RoomHandle wireObj) {
                wireObj.ptr = apiObj.shareOrMove();
            }



void _api_fill_to_wire_api_audio_track_constrs(ApiAudioTrackConstrs apiObj, wire_ApiAudioTrackConstrs wireObj) {
                wireObj.device_id = api2wire_opt_String(apiObj.deviceId);
            }

void _api_fill_to_wire_api_constrain_facing_mode(ApiConstrainFacingMode apiObj, wire_ApiConstrainFacingMode wireObj) {
...
void _api_fill_to_wire_api_device_video_track_constrs(ApiDeviceVideoTrackConstrs apiObj, wire_ApiDeviceVideoTrackConstrs wireObj) {
                wireObj.device_id = api2wire_opt_String(apiObj.deviceId);
wireObj.facing_mode = api2wire_box_api_option_constrain_facing_mode(apiObj.facingMode);
...
void _api_fill_to_wire_api_display_video_track_constrs(ApiDisplayVideoTrackConstrs apiObj, wire_ApiDisplayVideoTrackConstrs wireObj) {
                wireObj.device_id = api2wire_opt_String(apiObj.deviceId);
wireObj.height = api2wire_box_api_option_constrain_u_32(apiObj.height);
wireObj.width = api2wire_box_api_option_constrain_u_32(apiObj.width);
wireObj.frame_rate = api2wire_box_api_option_constrain_u_32(apiObj.frameRate);
            }

void _api_fill_to_wire_api_media_stream_settings(ApiMediaStreamSettings apiObj, wire_ApiMediaStreamSettings wireObj) {
                wireObj.audio = api2wire_box_api_audio_track_constrs(apiObj.audio);
wireObj.device_video = api2wire_opt_box_autoadd_api_device_video_track_constrs(apiObj.deviceVideo);
wireObj.display_video = api2wire_opt_box_autoadd_api_display_video_track_constrs(apiObj.displayVideo);
            }

void _api_fill_to_wire_api_option_constrain_facing_mode(ApiOptionConstrainFacingMode apiObj, wire_ApiOptionConstrainFacingMode wireObj) {
                if (apiObj is ApiOptionConstrainFacingMode_Some) {
                                var pre_field0 = api2wire_box_autoadd_api_constrain_facing_mode(apiObj.field0);
                                wireObj.tag = 0;
                                wireObj.kind = inner.inflate_ApiOptionConstrainFacingMode_Some();
                                wireObj.kind.ref.Some.ref.field0 = pre_field0;
                                return;
                            }
if (apiObj is ApiOptionConstrainFacingMode_None) { wireObj.tag = 1; return; }
            }

void _api_fill_to_wire_api_option_constrain_u_32(ApiOptionConstrainU32 apiObj, wire_ApiOptionConstrainU32 wireObj) {
...
if (apiObj is ApiOptionConstrainU32_None) { wireObj.tag = 1; return; }
            }



void _api_fill_to_wire_box_api_audio_track_constrs(ApiAudioTrackConstrs apiObj, ffi.Pointer<wire_ApiAudioTrackConstrs> wireObj) {
                _api_fill_to_wire_api_audio_track_constrs(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_api_option_constrain_facing_mode(ApiOptionConstrainFacingMode apiObj, ffi.Pointer<wire_ApiOptionConstrainFacingMode> wireObj) {
                _api_fill_to_wire_api_option_constrain_facing_mode(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_api_option_constrain_u_32(ApiOptionConstrainU32 apiObj, ffi.Pointer<wire_ApiOptionConstrainU32> wireObj) {
                _api_fill_to_wire_api_option_constrain_u_32(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_api_constrain_facing_mode(ApiConstrainFacingMode apiObj, ffi.Pointer<wire_ApiConstrainFacingMode> wireObj) {
                _api_fill_to_wire_api_constrain_facing_mode(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_api_device_video_track_constrs(ApiDeviceVideoTrackConstrs apiObj, ffi.Pointer<wire_ApiDeviceVideoTrackConstrs> wireObj) {
                _api_fill_to_wire_api_device_video_track_constrs(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_api_display_video_track_constrs(ApiDisplayVideoTrackConstrs apiObj, ffi.Pointer<wire_ApiDisplayVideoTrackConstrs> wireObj) {
                _api_fill_to_wire_api_display_video_track_constrs(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_api_media_stream_settings(ApiMediaStreamSettings apiObj, ffi.Pointer<wire_ApiMediaStreamSettings> wireObj) {
                _api_fill_to_wire_api_media_stream_settings(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_constrain_u_32(ConstrainU32 apiObj, ffi.Pointer<wire_ConstrainU32> wireObj) {
                _api_fill_to_wire_constrain_u_32(apiObj, wireObj.ref);
            }



void _api_fill_to_wire_constrain_u_32(ConstrainU32 apiObj, wire_ConstrainU32 wireObj) {
...
void _api_fill_to_wire_opt_box_autoadd_api_device_video_track_constrs(ApiDeviceVideoTrackConstrs? apiObj, ffi.Pointer<wire_ApiDeviceVideoTrackConstrs> wireObj) {
                if (apiObj != null) _api_fill_to_wire_box_autoadd_api_device_video_track_constrs(apiObj, wireObj);
            }

void _api_fill_to_wire_opt_box_autoadd_api_display_video_track_constrs(ApiDisplayVideoTrackConstrs? apiObj, ffi.Pointer<wire_ApiDisplayVideoTrackConstrs> wireObj) {
                if (apiObj != null) _api_fill_to_wire_box_autoadd_api_display_video_track_constrs(apiObj, wireObj);
            }
...
class MedeaJasonWire implements FlutterRustBridgeWireBase {
            @internal
            late final dartApi = DartApiDl(initialize);
  ...
  late final _initialize =
      _initializePtr.asFunction<bool Function(ffi.Pointer<ffi.Void>)>();
